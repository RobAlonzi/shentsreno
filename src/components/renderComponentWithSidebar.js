				...
				<div>
					...
					<nav id="sidebar-right" className={`sidebar-menu ${this.props.sidebar ? "is-active" : null}`}>
						...
						<ul>
							...
							<li className="sidebar-menu-item"><a href="#" className="sidebar-menu-link">Contact</a></li>
						</ul>
					...
					<div id="sidebar-mask" className={`sidebar-mask ${this.props.sidebar ? "is-active" : null}`} onClick={this.handleCloseSidebar}></div>
				</div>
			);
		}
	}
