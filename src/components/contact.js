				...
				<section className="section-contact">
					<div className="page-wrap">
						<div className="contact-text">
							<h1>Contact Us</h1>
							<p>If you have any questions or would like to book an appointment give us a call or send us an email.</p>

							<div className="contact-block">
								<h2><MapPin /> Our Location</h2>
								<p>Toronto, Ontario, Canada</p>
							</div>

							<div className="contact-block">
								<h2><Phone /> By Phone</h2>
								<p>416-460-9335</p>
								<p>Mon-Fri, 9AM - 5PM</p>
							</div>
							...
							<div className="contact-block">
								<h2><Mail />By Email</h2>
								<p><a href="mailto:shents.reno@gmail.com">shents.reno@gmail.com</a></p>
							</div>

							<div className="contact-block web-links">
							<a href="https://www.instagram.com/shentsrenovation/" target="_blank"><h2><Instagram /> @shentsreno</h2></a>
								<a href="https://homestars.com/companies/2849010-shents-renovation" className="homestars-link" target="_blank">
									<svg viewBox="0 0 1236.7 524.4">
										<g>
											<path fill="#28A9E2" d="M904.3,261.7c-2.2,1.2-3.8,2.7-4.6,4.3c-0.9,1.7-1.3,3.5-1.3,5.5c0,2.9,0.9,5.3,2.8,7.2 c1.9,1.9,4.5,2.9,8,2.9c2.7,0,5.3-0.6,7.6-1.7c2.3-1.2,4.2-2.7,5.8-4.5c1.6-1.9,2.8-4.1,3.8-6.6c0.9-2.5,1.4-5.1,1.4-7.7v-3.5 c-5.8,0-10.5,0.4-14.4,1.1C909.5,259.6,906.5,260.5,904.3,261.7z" />
											<path fill="#28A9E2" d="M331.7,222.8c-2.6,0-5.1,0.5-7.6,1.5c-2.4,1-4.6,2.6-6.6,4.7c-1.9,2.2-3.5,4.9-4.6,8.3 c-1.2,3.4-1.7,7.4-1.7,12.2c0,9.9,1.6,17.2,4.7,21.8c3.2,4.6,8.2,6.9,15.1,6.9c6,0,10.9-2.4,14.6-7.1c3.7-4.7,5.5-11.7,5.5-20.7 c0-9.2-1.5-16.1-4.5-20.7C343.5,225.1,338.6,222.8,331.7,222.8z" />
											<path fill="#28A9E2" d="M627.5,218.5c-4.7,0-8.7,1.7-11.9,5.2c-3.2,3.5-5,8-5.6,13.6h32.6c0.3-6.2-1-10.9-3.8-14 C636.1,220.1,632.3,218.5,627.5,218.5z" />
						...
						<div className="contact-image">
							<img src="https://maps.google.com/maps/api/staticmap?size=400x400&amp;zoom=9&amp;scale=1&amp;sensor=false&amp;markers=43.6639%2C-79.5446&amp;path=fillcolor:0x1E824C%7Ccolor:0x26A561%7Cenc:sxckGv`odNnO{dIbp@m~HxoAuqHzmB}~GxiCqfG|bD_iFzxDyfEdkE{`DnyEwwBncFklA`iFq_@`jFvKnfFzx@l~ErdB~qEnnCpaEjuDhmDvxEtuCzwFd{BbrGh~AbgHp_AjvHp_@r_I?vbIq_@r_Iq_AjvHi~AbgHe{BbrGuuCzwFimDvxEqaEjuD_rEnnCm~ErdBofFzx@ajFvKaiFq_@ocFklAoyEwwBekE{`D{xDyfE}bD_iFyiCqfG{mB}~GyoAuqHcp@m~HoO{dI" />
						</div>
					</div>
				</section>
			</div>
